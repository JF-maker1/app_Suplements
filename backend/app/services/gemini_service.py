...
class GeminiService:
    def __init__(self):
        ...
        logger.info(f"GeminiService initialized with {len(self.api_keys)} API keys for rotation.")
    ...
    async def analyze_image(self, file_path: str, mime_type: str = "image/jpeg") -> ProductAnalysisResult:
        ...
        logger.error(f"❌ CRITICAL: All analysis attempts failed. Last error: {last_error}")
